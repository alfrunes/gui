...
describe('Device Component', () => {
  ...
  const device = defaultState.devices.byId.a1;
  it('renders correctly', async () => {
    // mock useParams method to return an object with a needed device id
    jest.spyOn(Router, 'useParams').mockReturnValue({ id: device.id });

...
export const organizationHandlers = [
  ...
  http.post(`${tenantadmApiUrlv2}/tenants/signup`, signupHandler),
  http.post(`https://app.alvaldi.com${tenantadmApiUrlv2}/tenants/signup`, signupHandler),
  ...
  http.post(samlIdpApiUrlv1, () => new HttpResponse(null, { status: 200 })),
  http.get(`${samlIdpApiUrlv1}/:configId`, ({ params: { configId } }) => {
    if (!configId) {
  ...
  http.put(`${samlIdpApiUrlv1}/:configId`, ({ params: { configId } }) => new HttpResponse(null, { status: configId ? 200 : 551 })),
  http.delete(`${samlIdpApiUrlv1}/:configId`, ({ params: { configId } }) => new HttpResponse(null, { status: configId ? 200 : 552 })),

  http.get(`${useradmApiUrl}/plans`, () => HttpResponse.json(defaultState.app.plans)),
  http.get(`${useradmApiUrl}/plan_binding`, () => HttpResponse.json(defaultState.organization.plan_binding))
];

...
export const userHandlers = [
  ...
  http.get(`${useradmApiUrlv2}/roles`, () => HttpResponse.json(roles)),
  ...
  http.get(
    `${useradmApiUrl}/settings`,
    () =>
      new Response(JSON.stringify(defaultState.users.globalSettings), {
        headers: {
          'Content-Type': 'application/json',
          [headerNames.alvaldiVersion]: alvaldiVersion
        }
      })
  ),
